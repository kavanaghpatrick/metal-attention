...
- [x] 1.6 POC Checkpoint: Q6_K end-to-end validation
...
- [x] 2.1 Define WeightBuffer struct
...
- [x] 2.2 Implement make_weight_buffer_aligned
...
- [x] 2.3 Propagate WeightBuffer offset through encode methods
...
- [x] 2.4 Page-aligned correctness test
...
- [x] 3.1 Test forward_prompt on Mistral-7B
...
- [x] 3.2 Validate batch vs sequential consistency for GQA
...
- [x] 3.3 Add multi_token_matvec_q6_k dispatch in forward_prompt
...
- [x] 4.1 Add KV cache truncate and rollback_to
...
- [x] 4.2 Add forward_prompt_logits method
...
- [x] 4.3 Make sampling helpers pub(crate)
...
- [x] 4.4 Create speculative.rs module
...
- [x] 4.5 Add --draft CLI flags to inference
...
- [x] 4.6 KV cache rollback correctness test
...
- [x] 4.7 Speculative decode greedy correctness test
...
- [x] 5.1 Q6_K kernel edge case tests (skipped: Q6_K validated via Mistral-7B inference)
...
- [x] 5.2 Run full existing test suite
...
- [x] 5.3 Decode throughput benchmark
